...
public class ProductCommentDTO {
	...
	public ProductCommentDTO(String prd_no, String prd_nm, String img_gen_file_nm) {
		super();
		this.prd_no = prd_no;
		this.prd_nm = prd_nm;
	...
	public ProductCommentDTO(String prd_no, String prd_nm, String category_no, String prd_des, int sell_prc_unit,
