...
import mapred.exam.stock.StockDriver;
import mapred.exam.stock.StockMapper;
import mapred.exam.stock.StockReducer;
...
public class StockMultipleDriver extends Configured implements Tool{
	...
	public int run(String[] optionlist) throws Exception {
		...
		MultipleOutputs.addNamedOutput(job, "increase", TextOutputFormat.class, Text.class, IntWritable.class);
		MultipleOutputs.addNamedOutput(job, "decrease", TextOutputFormat.class, Text.class, IntWritable.class);
